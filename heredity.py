...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if not father and not mother:
            ...
            mother = 1 - \
                PROBS['mutation'] if mother in two_genes else 0.5 if mother in one_gene else PROBS['mutation']
            father = 1 - \
                PROBS['mutation'] if father in two_genes else 0.5 if father in one_gene else PROBS['mutation']
